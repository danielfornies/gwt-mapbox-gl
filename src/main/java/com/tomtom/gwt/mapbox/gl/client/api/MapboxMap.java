...
import com.tomtom.gwt.mapbox.gl.client.api.mapoptions.FlyToOptions;
import com.tomtom.gwt.mapbox.gl.client.api.mapoptions.MapOptions;
import com.tomtom.gwt.mapbox.gl.client.api.mapoptions.QueryRenderedFeaturesParams;
import com.tomtom.gwt.mapbox.gl.client.api.mapoptions.QuerySourceFeaturesParams;
import com.tomtom.gwt.mapbox.gl.client.style.sources.AbstractSourceInput;
import com.tomtom.gwt.mapbox.gl.client.api.overlay.AbstractOverlay;
import static com.tomtom.gwt.mapbox.gl.client.util.Constants.MAPBOX_GL_NAMESPACE;
import java.util.Collection;
import jsinterop.annotations.JsOverlay;
import jsinterop.annotations.JsType;
import com.tomtom.gwt.mapbox.gl.client.api.sources.MapSource;
import com.tomtom.gwt.mapbox.gl.client.api.handlers.BoxZoomHandler;
import com.tomtom.gwt.mapbox.gl.client.api.handlers.DoubleClickZoomHandler;
import com.tomtom.gwt.mapbox.gl.client.api.handlers.DragPanHandler;
import com.tomtom.gwt.mapbox.gl.client.api.handlers.DragRotateHandler;
import com.tomtom.gwt.mapbox.gl.client.api.handlers.KeyboardHandler;
import com.tomtom.gwt.mapbox.gl.client.api.handlers.ScrollZoomHandler;
import com.tomtom.gwt.mapbox.gl.client.api.handlers.TouchZoomRotateHandler;
import com.tomtom.gwt.mapbox.gl.client.style.other.Filter;
import com.tomtom.gwt.mapbox.gl.client.api.mapoptions.AnimationOptions;
import com.tomtom.gwt.mapbox.gl.client.api.mapoptions.CameraOptions;
import com.tomtom.gwt.mapbox.gl.client.api.mapoptions.EaseToOptions;
import com.tomtom.gwt.mapbox.gl.client.api.mapoptions.LightOptions;
import com.tomtom.gwt.mapbox.gl.client.style.MapboxStyle;
import jsinterop.annotations.JsProperty;
import com.tomtom.gwt.mapbox.gl.client.api.mapoptions.ImageLoadCallback;
...
public class MapboxMap extends AbstractEvented {
     ...
     *
     * @param geometry (Point) The single point where to query for rendered features.
    ...
    /**
     * Returns an array of GeoJSON Feature objects representing visible features that satisfy the query parameters.
     * The current map viewport is considered.
     * @param parameters an instance of QueryRenderedFeaturesParams.
     * @return Array of GeoJson: An array of GeoJSON feature objects . The properties value of each returned feature object contains the properties of its source feature. For GeoJSON sources,
     * only string and numeric property values are supported (i.e. null, Array, and Object values are not supported).
     *
